...
public class ProblemSet {
    ...
    private void loadProblem(String problemName) {
        ...
        //Reading the answer
        try {
            r = new Scanner(new File("Problems" + File.separator + getName() + File.separator + problemName + File.separator + "ProblemAnswer.txt"));
        } catch(Exception ex) {
            System.out.println(ex);
        }
        ...
        RavensProblem newProblem = new RavensProblem(problemName, problemType, this.name, hasVisual, hasVerbal);
        if(hasVerbal) {
